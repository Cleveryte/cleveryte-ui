    ...
    if (size === 'small') {
      ...
      postContent = (
        <>
            ...
            <Link to={`/blog/${postId}`}>
              <h2 className="text-black font-black text-4xl mb-1 hover:underline hover:underline-offset-4 hover:text-[#9C00B6]">{title}</h2>
            </Link>
      ...
      postContent = (
        <>
            ...
            <h4 className="text-gray-600 mt-4 text-lg font-bold">{topic}</h4>
            <Link to={`/blog/${postId}`}>
              <h2 className="text-black font-black text-5xl mb-1 hover:underline hover:underline-offset-4 hover:text-[#9C00B6]">{title}</h2>
            </Link>
            <p className="text-gray-500 font-light">{description}</p>
