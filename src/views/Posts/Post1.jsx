  ...
  return (
    <div>
      <div className="text-start"> 
        <Link to={"/blog"}>
          <button className="my-6 text-black dark:text-white px-4 py-2 rounded flex items-center font-bold gap-2"> 
          <Icon className="text-xs dark:text-white" icon="ep:arrow-left-bold"/> Go Back
          </button>
        </Link>
      </div>
    <div className="post-container mt-10">
        <p className="text-[#f5f5f5] font-normal text-lg my-8">January 02, 2024</p>
        
        <h2 className="font-extrabold text-2xl md:text-5xl mb-3 tracking-wide dark:text-white">Introducing CleveryteUI: Revolutionizing web development with tailwindCSS components</h2>
        ...
        <hr className="my-5"/>
        <h2 className="font-bold text-2xl mb-4 dark:text-white">¿Where to start?</h2>
        <p className="mb-4 text-[#4c4c4c] dark:text-[#f5f5f5] font-normal text-lg">
    ...
    <div className="post-container mt-10">
    <h2 className="font-bold text-2xl mb-4 dark:text-white">Ready-to-Use Components</h2>
        <p className="mb-4 text-[#4c4c4c] font-normal text-lg dark:text-[#f5f5f5]">
